...
export const GlobeAltIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 8.027a6.012 6.012 0 011.912-2.706C6.512 5.73 6.974 6 7.5 6A1.5 1.5 0 019 7.5V8a2 2 0 004 0 2 2 0 011.523-1.943A5.977 5.977 0 0116 10c0 .34-.028.675-.083 1H15a2 2 0 00-2 2v2.197A5.973 5.973 0 0110 16a5.973 5.973 0 01-2.197-4.803V11a2 2 0 00-2-2H4.083A5.977 5.977 0 014 10c0-.34.028.675.083-1h.249z" clipRule="evenodd" />
    </svg>
);
...
export const CrownIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-amber-400" viewBox="0 0 20 20" fill="currentColor">
      <path d="M11.05 3.45a.75.75 0 01.9 0l1.5 1.5a.75.75 0 01-.53 1.28h-3.84a.75.75 0 01-.53-1.28l1.5-1.5zM6.5 6.75A.75.75 0 005 7.5v.043a.75.75 0 00.75.75h8.5a.75.75 0 00.75-.75V7.5a.75.75 0 00-1.5 0v.018a.25.25 0 01-.25.25h-5.5a.25.25 0 01-.25-.25V7.5a.75.75 0 00-.75-.75z" />
      <path fillRule="evenodd" d="M6.25 8.293a.25.25 0 01.25-.25h6.5a.25.25 0 01.25.25v6.5a.25.25 0 01-.25.25h-6.5a.25.25 0 01-.25-.25v-6.5zM5 8.043a.75.75 0 00-1.5 0v7.207a.75.75 0 00.75.75h10.5a.75.75 0 00.75-.75V8.043a.75.75 0 00-1.5 0v6.957a.25.25 0 01-.25.25H5.25a.25.25 0 01-.25-.25V8.043z" clipRule="evenodd" />
    </svg>
);
